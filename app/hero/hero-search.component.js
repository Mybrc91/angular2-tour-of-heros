...
var HeroSearchComponent = (function () {
    function HeroSearchComponent(heroSearchSerivce, router) {
        this.heroSearchSerivce = heroSearchSerivce;
        this.router = router;
        this.searchTeims = new Subject_1.Subject();
    }
    HeroSearchComponent.prototype.search = function (trem) {
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        this.heroes = this.searchTeims
            ...
            .switchMap(function (trem) { return trem ? _this.heroSearchSerivce.search(trem) : Observable_1.Observable.of([]); })
